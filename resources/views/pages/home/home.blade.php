<div class="overflow-x-hidden">
    {{-- Hero Section --}}
    <section class="relative min-h-screen overflow-hidden bg-linear-to-br from-[#0a1f1f] via-[#0d2e2e] to-[#0a2525]">
        {{-- Background effects --}}
        <div class="absolute inset-0 overflow-hidden">
            <div class="absolute -top-20 -right-20 h-40 w-40 rounded-full bg-teal-500/10 blur-3xl md:-top-40 md:-right-40 md:h-96 md:w-96"></div>
            <div class="absolute top-1/3 -left-20 h-40 w-40 rounded-full bg-emerald-500/10 blur-3xl md:-left-40 md:h-80 md:w-80"></div>
        </div>
        ...
        <header class="relative z-10 flex items-center justify-between px-4 py-4 md:px-12 md:py-6">
            <div class="flex items-center gap-2">
                <div class="flex h-8 w-8 items-center justify-center md:h-10 md:w-10">
                    <svg class="h-6 w-6 text-teal-400 md:h-8 md:w-8" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div class="flex items-center gap-2 md:gap-4">
                ...
                <a href="{{ route('register') }}" wire:navigate class="rounded-full bg-linear-to-r from-teal-500 to-emerald-500 px-4 py-2 text-xs font-semibold text-white transition-all hover:scale-105 md:px-6 md:text-sm">
                    Join Now
                </a>
            </div>
        </header>
        ...
        <div class="relative mx-auto flex min-h-[85vh] max-w-7xl flex-col items-center justify-center px-4 py-8 md:px-6 lg:flex-row lg:justify-between lg:py-0">
            ...
            <div class="max-w-xl text-center lg:text-left">
                <div class="mb-4 inline-flex items-center gap-2 rounded-full border border-teal-500/30 bg-teal-500/10 px-3 py-1.5 text-xs text-teal-300 md:mb-6 md:px-4 md:py-2 md:text-sm">
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:justify-center lg:justify-start">
                    <a href="{{ route('register') }}" wire:navigate class="group inline-flex items-center justify-center gap-2 rounded-xl bg-linear-to-r from-teal-500 to-emerald-500 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-teal-500/25 transition-all duration-300 hover:scale-105 md:px-8 md:py-4 md:text-lg">
                        Get Started
                    ...
                    <a href="#earnings" class="inline-flex items-center justify-center gap-2 rounded-xl border border-teal-700 bg-teal-900/30 px-6 py-3 text-sm font-semibold text-white transition-all hover:border-teal-500 hover:bg-teal-900/50 md:px-8 md:py-4 md:text-lg">
                        View Earnings
                    </a>
                </div>
            </div>
            ...
            <div class="mt-8 w-full max-w-xs px-4 sm:max-w-sm md:max-w-md lg:mt-0 lg:max-w-lg lg:px-0">
                <img src="/images/stream/hero.jpg" alt="Stream Skill Up" class="w-full rounded-2xl shadow-2xl shadow-teal-500/20">
            </div>
        </div>
    </section>
        ...
        <div class="mx-auto max-w-7xl px-4 md:px-6">
            <div class="grid items-center gap-8 md:gap-12 lg:grid-cols-2">
                ...
                <div class="order-1 lg:order-2">
                    <span class="mb-3 inline-block rounded-full bg-teal-500/10 px-3 py-1 text-xs font-medium text-teal-400 md:mb-4 md:px-4 md:text-sm">About Us</span>
    ...
    <section class="bg-linear-to-b from-[#081818] to-[#0a1f1f] py-12 md:py-24">
        <div class="mx-auto max-w-7xl px-4 md:px-6">
            <div class="mb-8 text-center md:mb-16">
                <span class="mb-3 inline-block rounded-full bg-emerald-500/10 px-3 py-1 text-xs font-medium text-emerald-400 md:mb-4 md:px-4 md:text-sm">How You Earn</span>
            ...
            <div class="grid gap-4 md:gap-8 lg:grid-cols-2">
                {{-- Audio Collaboration --}}
                <div class="group overflow-hidden rounded-xl border border-teal-800/50 bg-teal-900/20 transition-all hover:border-teal-500/50 md:rounded-2xl">
    ...
    <section id="earnings" class="bg-[#0a1f1f] py-12 md:py-24">
        <div class="mx-auto max-w-7xl px-4 md:px-6">
            <div class="grid items-center gap-8 md:gap-12 lg:grid-cols-2">
                {{-- Content --}}
                <div>
                    <span class="mb-3 inline-block rounded-full bg-emerald-500/10 px-3 py-1 text-xs font-medium text-emerald-400 md:mb-4 md:px-4 md:text-sm">Earnings</span>
                    <h2 class="mb-4 text-2xl font-bold text-white md:mb-6 md:text-4xl lg:text-5xl">Earning Based on Duration</h2>
                    <p class="mb-6 text-base font-semibold text-teal-400 md:mb-8 md:text-xl">Easy Stream. Easy Cash.</p>

                    <div class="space-y-3 md:space-y-4">
                        {{-- Audio Collab --}}
                        <div class="rounded-lg border border-teal-800/50 bg-teal-900/20 p-3 md:rounded-xl md:p-4">
                            <div class="flex items-center gap-3 md:gap-4">
                                <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-teal-500/20 md:h-12 md:w-12">
                                    <svg class="h-5 w-5 text-teal-400 md:h-6 md:w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3" />
                                    </svg>
                                </div>
                                <div class="min-w-0">
                                    <h4 class="text-sm font-semibold text-white md:text-base">Audio Collab</h4>
                                    <p class="text-xs text-gray-400 md:text-sm">30 secs = <span class="font-bold text-teal-400">₦1,550</span> | 3-min = <span class="font-bold text-teal-400">₦9,300</span></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="rounded-lg border border-teal-800/50 bg-teal-900/20 p-3 md:rounded-xl md:p-4">
                            <div class="flex items-center gap-3 md:gap-4">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="text-xs text-gray-400 md:text-sm">60 secs = <span class="font-bold text-teal-400">₦2,750</span> | 5-min = <span class="font-bold text-teal-400">₦13,750</span></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="rounded-lg border border-teal-800/50 bg-teal-900/20 p-3 md:rounded-xl md:p-4">
                            <div class="flex items-center gap-3 md:gap-4">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="text-xs text-gray-400 md:text-sm">2 mins = <span class="font-bold text-teal-400">₦5,700</span> | 10 mins = <span class="font-bold text-teal-400">₦28,500</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section id="pricing" class="bg-linear-to-b from-[#081818] to-[#0a1f1f] py-12 md:py-24">
        <div class="mx-auto max-w-7xl px-4 md:px-6">
            <div class="mb-8 text-center md:mb-16">
                <span class="mb-3 inline-block rounded-full bg-teal-500/10 px-3 py-1 text-xs font-medium text-teal-400 md:mb-4 md:px-4 md:text-sm">Membership</span>
            ...
            <div class="grid items-center gap-8 md:gap-12 lg:grid-cols-2">
                ...
                {{-- Pricing Details --}}
                <div>
                    <div class="rounded-xl border-2 border-teal-500 bg-linear-to-b from-teal-900/30 to-[#081818] p-4 md:rounded-2xl md:p-8">
                        ...
                        <div class="mb-6 space-y-3 md:mb-8 md:space-y-4">
                            <h4 class="text-sm font-semibold text-teal-400 md:text-base">What You Get:</h4>
                            <ul class="space-y-2 md:space-y-3">
                                ...
                                @foreach ($benefits as $benefit)
                                    <li class="flex items-start gap-2 text-xs text-gray-300 md:gap-3 md:text-sm">
                                        <svg class="mt-0.5 h-4 w-4 shrink-0 text-teal-500 md:h-5 md:w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                        </svg>
                                        <span>{{ $benefit['text'] }} @if($benefit['value']) - <span class="text-teal-400">{{ $benefit['value'] }}</span>@endif</span>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                        ...
                        <div class="mb-4 rounded-lg bg-teal-500/10 p-3 text-center md:mb-6 md:p-4">
                            <p class="text-xs text-teal-300 md:text-sm">TikTok Creator's Network = <span class="font-bold">₦200,000 monthly</span></p>
                        </div>

                        <a href="{{ route('register') }}" wire:navigate class="block w-full rounded-lg bg-linear-to-r from-teal-500 to-emerald-500 px-4 py-3 text-center text-sm font-semibold text-white shadow-lg shadow-teal-500/25 transition-all hover:scale-105 md:rounded-xl md:px-6 md:py-4 md:text-lg">
                            Join Stream Now
                        </a>
                    </div>
                </div>
    ...
    <section class="bg-[#0a1f1f] py-12 md:py-24">
        <div class="mx-auto max-w-7xl px-4 md:px-6">
            <div class="mb-8 text-center md:mb-16">
                <span class="mb-3 inline-block rounded-full bg-cyan-500/10 px-3 py-1 text-xs font-medium text-cyan-400 md:mb-4 md:px-4 md:text-sm">Stream SkillUp</span>
            ...
            <div class="grid grid-cols-2 gap-2 md:grid-cols-3 md:gap-4 lg:grid-cols-5">
                ...
                @foreach ($skills as $skill)
                    <div class="rounded-lg border border-teal-800/50 bg-teal-900/20 px-3 py-3 text-center transition-all hover:border-teal-500/50 hover:bg-teal-900/30 md:rounded-xl md:px-4 md:py-4">
    ...
    {{-- CTA Section --}}
    <section class="relative overflow-hidden bg-linear-to-br from-teal-900 via-[#0a1f1f] to-emerald-900 py-12 md:py-24">
        <div class="absolute inset-0">
            <div class="absolute left-1/4 top-0 h-40 w-40 rounded-full bg-teal-500/10 blur-3xl md:h-96 md:w-96"></div>
            <div class="absolute bottom-0 right-1/4 h-40 w-40 rounded-full bg-emerald-500/10 blur-3xl md:h-96 md:w-96"></div>
        </div>
        ...
        <div class="relative mx-auto max-w-4xl px-4 text-center md:px-6">
            ...
            <p class="mb-6 text-base font-semibold text-teal-400 md:mb-10 md:text-xl">
                Get Onboard Today.
            </p>
            <a href="{{ route('register') }}" wire:navigate class="inline-flex items-center justify-center gap-2 rounded-lg bg-linear-to-r from-teal-500 to-emerald-500 px-6 py-3 text-sm font-semibold text-white shadow-xl shadow-teal-500/25 transition-all hover:scale-105 md:rounded-xl md:px-8 md:py-4 md:text-lg">
                Start Earning Now
                <svg class="h-4 w-4 md:h-5 md:w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3" />
                </svg>
            ...
            <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div>
                    ...
                    <div class="flex gap-3 md:gap-4">
                        <a href="#" class="flex h-9 w-9 items-center justify-center rounded-lg bg-teal-900/50 text-gray-400 transition-colors hover:bg-teal-800 hover:text-white md:h-10 md:w-10">
                ...
                <div>
                    ...
                    <ul class="space-y-2 md:space-y-3">
                        <li><a href="#about" class="text-sm text-gray-400 transition-colors hover:text-teal-400">About Us</a></li>
                        <li><a href="#earnings" class="text-sm text-gray-400 transition-colors hover:text-teal-400">Earnings</a></li>
                        <li><a href="#pricing" class="text-sm text-gray-400 transition-colors hover:text-teal-400">Pricing</a></li>
                        <li><a href="#" class="text-sm text-gray-400 transition-colors hover:text-teal-400">SkillUp</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 md:space-y-3">
                        <li><a href="#" class="text-sm text-gray-400 transition-colors hover:text-teal-400">Audio Collab</a></li>
                        <li><a href="#" class="text-sm text-gray-400 transition-colors hover:text-teal-400">Video Collab</a></li>
                        <li><a href="#" class="text-sm text-gray-400 transition-colors hover:text-teal-400">Livestream</a></li>
                        <li><a href="#" class="text-sm text-gray-400 transition-colors hover:text-teal-400">Stream Bazaar</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 md:space-y-3">
                        ...
                        <li><a href="#" class="text-sm text-gray-400 transition-colors hover:text-teal-400">Help Center</a></li>
                        <li><a href="#" class="text-sm text-gray-400 transition-colors hover:text-teal-400">Privacy Policy</a></li>
                        <li><a href="#" class="text-sm text-gray-400 transition-colors hover:text-teal-400">Terms</a></li>
                    </ul>
                </div>
            </div>

            <div class="mt-8 border-t border-teal-900 pt-6 text-center md:mt-12 md:pt-8">
